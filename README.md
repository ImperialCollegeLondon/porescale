...
| **[Porefoam2f](https://github.com/ImperialCollegeLondon/porefoam)** | <div align="center"><img src="readme_resources/Porefoam2f.jpg" width="600"/><br/><strong>Direct Numerical Simulation (DNS) of Incompressible Two-phase Flow on 3D Images of Porous Media Using OpenFOAM Finite-volume Library</strong></div> |
| **[ContactAngle](https://github.com/ImperialCollegeLondon/ContactAngle)** | <div align="center"><img src="readme_resources/ContactAngle.png" width="250"/><br/><strong>Automatic Measurements of Contact Angle, Interfacial Curvature, and Surface Roughness in Pore-Scale 3D-Images</strong></div> |
